...
export default function CarbonCeramicBrakesGuidePage() {
  ...
  return <article className={`${styles.article} mx-auto max-w-5xl bg-white px-4 py-10 font-sans text-slate-900 sm:px-6 md:py-16 lg:px-8`}>
    ...
    <header className="space-y-6">
      ...
      <p className="max-w-3xl text-base leading-[1.95] text-slate-600 sm:text-lg">กำลังดูชุดเบรกหลักแสนสำหรับล้อ 20 นิ้ว? เริ่มจากจาน 375–390 mm คาลิเปอร์ตั้งแต่ 6 พอต และราคาชุดหน้าใหม่ที่ตรวจย้อนกลับได้ คาลิเปอร์ 2 ตัว จาน 2 ใบ ผ้า ขายึด สาย และอุปกรณ์ต้องอยู่ในขอบเขตเดียวกัน แล้วค่อยตัดสินว่าเพิ่มสมรรถนะที่ใช้จริง ความสะอาดล้อ หรืองานสวยได้คุ้มแค่ไหน</p>
