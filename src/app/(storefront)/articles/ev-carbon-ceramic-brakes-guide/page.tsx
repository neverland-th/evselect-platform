  ...
  return <article className={`${styles.article} mx-auto max-w-5xl bg-white px-4 py-10 font-sans text-slate-900 sm:px-6 md:py-16 lg:px-8`}>
    ...
    <header className="space-y-6">
      ...
      <div className="max-w-3xl space-y-4 text-base leading-[1.95] text-slate-600 sm:text-lg">
        ...
        <p><Link href="/" className="underline decoration-current/30 underline-offset-4 hover:decoration-current">EVSELECT</Link> ชวนทำความรู้จัก Carbon Ceramic ทั้งเสน่ห์และสิ่งที่ต้องยอมรับ แล้วเทียบกับชุดเบรกจาก Brembo และ ENDLESS ในเรื่องสมรรถนะ ฝุ่น และค่าใช้จ่าย พร้อมประสบการณ์ ENDLESS จาน 375 mm บน Tesla Model 3 Performance Highland เพื่อช่วยตอบว่า สำหรับรถที่คุณใช้และทางที่คุณขับ การอัปเกรดแบบไหนคุ้มกับคุณที่สุด</p>
      </div>
      <div className="flex flex-wrap items-center gap-x-5 gap-y-2 text-sm text-slate-500"><span className="inline-flex items-center gap-2"><CalendarDays className="h-4 w-4" aria-hidden="true" />อัปเดต 19 ก.ย. 2569</span><span className="inline-flex items-center gap-2"><Clock className="h-4 w-4" aria-hidden="true" />ประมาณ {brakeArticle.readTime}</span><span><Link href="/" className="underline decoration-current/30 underline-offset-4 hover:decoration-current">EVSELECT</Link> · เรียบเรียงจากข้อมูลผู้ผลิต</span></div>
      ...
      <p data-contextual-reading className="mb-8 text-sm leading-relaxed text-slate-600">การเลือกเบรกควรมองยางและช่วงล่างร่วมกันด้วย หากยังแยกหน้าที่แต่ละชิ้นไม่ออก อ่าน <Link href="/articles/ev-damper-tuning-bump-rebound-guide#basics" className="font-semibold text-lime-800 underline underline-offset-4">ยาง สปริง และโช้คทำหน้าที่ต่างกันอย่างไร</Link> ก่อนตัดสินใจเปลี่ยนอุปกรณ์ทั้งชุด</p>
    ...
    <div className="mt-10 space-y-12 text-base leading-[1.95] sm:text-lg">
      <aside className="rounded-2xl border border-lime-200 bg-lime-50 p-5 sm:p-7">
        ...
        <p className="mt-3 text-sm text-slate-600">ล้อ 20 นิ้วเป็นโจทย์ตั้งต้น ไม่ใช่ใบรับรองว่าเบรกทุกชุดใส่ได้ ต้องตรวจทรงก้านล้อ ออฟเซ็ต และแบบระยะเคลียร์เฉพาะชุด นี่คือข้อเสนอเชิงบรรณาธิการตามลักษณะใช้งาน ไม่ใช่ผลทดสอบรถทุกคัน หรือคำรับรองสินค้าเฉพาะรุ่น <Link href="/" className="underline decoration-current/30 underline-offset-4 hover:decoration-current">EVSELECT</Link> ยังไม่มีสินค้าพร้อมจำหน่าย และยังไม่เปิดรับคำสั่งซื้อหรือชำระเงิน</p>
      </aside>

      <div className="flex flex-wrap gap-3"><a href="#japan" className="inline-flex min-h-11 items-center rounded-xl border border-slate-300 px-4 py-2 text-base font-semibold">ดูเคส ENDLESS 375 mm</a><a href="#brand-compare" className="inline-flex min-h-11 items-center rounded-xl bg-lime-400 px-4 py-2 text-base font-bold text-slate-950">กดเทียบ 3 แนวทางเบรก →</a></div>
      ...
      <Section id="disc-size" title="3. จานใหญ่ขึ้น หนาขึ้น มีประโยชน์ต่างกันอย่างไร?">
        <div className="grid gap-5 sm:grid-cols-2">
          ...
          <div className="rounded-2xl border border-slate-200 p-6"><h3 className="text-xl font-bold">ความหนา มวล และช่องลม → การรับและคายความร้อน</h3><p className="mt-4">เนื้อจานมากขึ้นช่วยรับพลังงานโดยอุณหภูมิเพิ่มช้าลงภายใต้เงื่อนไขเดียวกัน ส่วนช่องระบายอากาศภายในและอากาศที่ไหลเข้าช่วยพาความร้อนออก จานที่หนาหรือใหญ่ขึ้นอาจหนักขึ้น จึงต้องชั่งน้ำหนักชุดจริง</p><p className="mt-3 text-sm text-slate-500">ภาพซ้ายเป็นแผนภาพอธิบายของ <Link href="/" className="underline decoration-current/30 underline-offset-4 hover:decoration-current">EVSELECT</Link> ไม่ใช่แบบผลิตหรือภาพทดสอบชิ้นส่วน</p></div>
        </div>
      ...
      <Section id="surface" title="4. จานเรียบ เซาะร่อง เจาะรู — ลายจานบอกอะไรและไม่บอกอะไร">
        ...
        <Note>คำแนะนำด้านความคุ้มค่าในตารางเป็นการสังเคราะห์ของ <Link href="/" className="underline decoration-current/30 underline-offset-4 hover:decoration-current">EVSELECT</Link> ภาพเป็นตัวอย่างรูปแบบจากผู้ผลิต ไม่ยืนยันว่าจานตามภาพติดตั้งกับรถของผู้อ่านได้ ต้องตรวจรหัสชิ้นส่วนก่อนเสมอ</Note>
      </Section>
      ...
      <Section id="japan" title="7. เคสเจ้าของรถ: ENDLESS 6 พอต จาน 375 mm บน Model 3 Performance Highland">
        <p>เจ้าของรถรายงานว่าเคยใช้ ENDLESS 6 พอตกับจานหน้าคู่ <strong>375 mm</strong> บน Tesla Model 3 Performance Highland ต้นทุนคาลิเปอร์และจานคู่หน้าประมาณ <strong>200,000 บาท</strong> เป็นประสบการณ์ซื้อและใช้งานเฉพาะคัน ไม่ใช่ราคาเสนอขายปัจจุบันของ <Link href="/" className="underline decoration-current/30 underline-offset-4 hover:decoration-current">EVSELECT</Link></p>
        ...
        <Note>ยังไม่มีรายละเอียดจังหวะอ่านกล้อง จุดวัด ค่า emissivity หรือไฟล์ Thermal ให้ตรวจ จึงใช้ข้อมูลนี้เป็นประสบการณ์เจ้าของ ไม่เรียกว่าอุณหภูมิสูงสุดระหว่างเบรกที่ยืนยันแล้ว <Ref to="apTemp">AP Racing อธิบายว่าอุณหภูมิลดลงเร็วหลังหยุด</Ref> และไม่ควรคำนวณ 200 ÷ 700 เป็น “ใช้สมรรถนะไปกี่เปอร์เซ็นต์”</Note>
        <p><strong>ข้อเสนอของ <Link href="/" className="underline decoration-current/30 underline-offset-4 hover:decoration-current">EVSELECT</Link>:</strong> ถ้าการใช้งานจริงไม่มีอาการเฟด ระบบสมบูรณ์ และผลตรวจสอดคล้องกับขอบเขตชุด การขยับไปชุดร้อนกว่าเพียงเพื่อเพิ่มตัวเลขอาจไม่ตอบโจทย์ คุณอาจให้ค่าน้ำหนัก ฟีล ฝุ่น รูปลักษณ์ หรืออะไหล่ทดแทนมากกว่า แต่ต้องประเมินจากข้อมูลของรถคันนั้น ไม่สรุปว่าเบรกทุกคันใช้ไม่ถึง 200°C</p>
      </Section>
      ...
      <section id="sources" aria-labelledby="sources-title" className="rounded-2xl bg-slate-50 p-5 text-sm sm:p-7"><h2 id="sources-title" className="mb-4 text-xl font-bold">ที่มาและขอบเขตของบทความ</h2><p className="mb-4">ตรวจแหล่งข้อมูลวันที่ 19 กันยายน 2569 บทความนี้เป็นการสังเคราะห์เอกสารผู้ผลิตและการคำนวณตัวอย่างของ <Link href="/" className="underline decoration-current/30 underline-offset-4 hover:decoration-current">EVSELECT</Link> ไม่ใช่ผลทดสอบเบรกบนถนนไทย <Link href="/" className="underline decoration-current/30 underline-offset-4 hover:decoration-current">EVSELECT</Link> ไม่ได้วัดระยะหยุด ฝุ่น หรืออุณหภูมิจากรถจริงในงานนี้ ภาพและข้อมูล Model 3 Performance Highland เป็นข้อมูลที่เจ้าของส่งพร้อมยืนยันจาน 375 mm แยกจากราคาแคตตาล็อกและผลการทดสอบของผู้ผลิต คะแนนในกราฟเป็นการประเมินคร่าว ๆ โดย <Link href="/" className="underline decoration-current/30 underline-offset-4 hover:decoration-current">EVSELECT</Link> มีรีวิวผู้ใช้ต่างรถและต่างปีประกอบในช่องเหตุผล ไม่ใช่คะแนนเฉลี่ยจากลูกค้าหรือผลทดสอบมาตรฐาน ข้อมูลผลิตภัณฑ์และการรองรับรถอาจเปลี่ยนตามปี รุ่น และตลาด</p><ul className="list-disc space-y-2 pl-5">{Object.entries(brakeSources).map(([key, source]) => <li key={key}><a href={source.url} className="text-slate-600 underline underline-offset-4 hover:text-lime-800" target="_blank" rel="noopener noreferrer">{source.title}</a></li>)}</ul></section>
    ...
    <footer className="mt-12 flex flex-wrap items-center justify-between gap-4 border-t border-slate-200 pt-6 text-sm text-slate-500"><span><Link href="/" className="underline decoration-current/30 underline-offset-4 hover:decoration-current">EVSELECT</Link> · เข้าใจรถให้ลึก เลือกให้ตรงใจ</span><Link href="/articles" className="inline-flex min-h-11 items-center gap-2 font-medium text-lime-800">อ่านบทความอื่น<ArrowRight className="h-4 w-4" aria-hidden="true" /></Link></footer>
  </article>;
}
