  ...
  return <article className={`${styles.article} mx-auto max-w-5xl bg-white px-4 py-10 font-sans text-slate-900 sm:px-6 md:py-16 lg:px-8`}>
    ...
    <div className="mt-10 space-y-12 text-base leading-[1.95] sm:text-lg">
      <aside className="rounded-2xl border border-lime-200 bg-lime-50 p-5 sm:p-7">
        ...
        <p className="mt-3 text-sm text-slate-600">ล้อ 20 นิ้วเป็นโจทย์ตั้งต้น ไม่ใช่ใบรับรองว่าเบรกทุกชุดใส่ได้ ต้องตรวจทรงก้านล้อ ออฟเซ็ต และแบบระยะเคลียร์เฉพาะชุด นี่คือข้อเสนอเชิงบรรณาธิการตามลักษณะใช้งาน ไม่ใช่ผลทดสอบรถทุกคัน หรือคำรับรองสินค้าเฉพาะรุ่น EVSELECT ยังไม่มีสินค้าพร้อมจำหน่าย และยังไม่เปิดรับคำสั่งซื้อหรือชำระเงิน</p>
      </aside>
      ...
      <Section id="japan" title="7. เคสเจ้าของรถ: ENDLESS 6 พอต จาน 375 mm บน Model 3 Performance Highland">
        <p>เจ้าของรถรายงานว่าเคยใช้ ENDLESS 6 พอตกับจานหน้าคู่ <strong>375 mm</strong> บน Tesla Model 3 Performance Highland ต้นทุนคาลิเปอร์และจานคู่หน้าประมาณ <strong>200,000 บาท</strong> เป็นประสบการณ์ซื้อและใช้งานเฉพาะคัน ไม่ใช่ราคาเสนอขายปัจจุบันของ EVSELECT</p>
        ...
        <p><strong>ข้อเสนอของ EVSELECT:</strong> ถ้าการใช้งานจริงไม่มีอาการเฟด ระบบสมบูรณ์ และผลตรวจสอดคล้องกับขอบเขตชุด การขยับไปชุดร้อนกว่าเพียงเพื่อเพิ่มตัวเลขอาจไม่ตอบโจทย์ คุณอาจให้ค่าน้ำหนัก ฟีล ฝุ่น รูปลักษณ์ หรืออะไหล่ทดแทนมากกว่า แต่ต้องประเมินจากข้อมูลของรถคันนั้น ไม่สรุปว่าเบรกทุกคันใช้ไม่ถึง 200°C</p>
      </Section>
      ...
      <section id="sources" aria-labelledby="sources-title" className="rounded-2xl bg-slate-50 p-5 text-sm sm:p-7"><h2 id="sources-title" className="mb-4 text-xl font-bold">ที่มาและขอบเขตของบทความ</h2><p className="mb-4">ตรวจแหล่งข้อมูลวันที่ 19 กันยายน 2569 บทความนี้เป็นการสังเคราะห์เอกสารผู้ผลิตและการคำนวณตัวอย่างของ EVSELECT ไม่ใช่ผลทดสอบเบรกบนถนนไทย EVSELECT ไม่ได้วัดระยะหยุด ฝุ่น หรืออุณหภูมิจากรถจริงในงานนี้ ภาพและข้อมูล Model 3 Performance Highland เป็นข้อมูลที่เจ้าของส่งพร้อมยืนยันจาน 375 mm แยกจากราคาแคตตาล็อกและผลการทดสอบของผู้ผลิต คะแนนในกราฟเป็นการประเมินคร่าว ๆ โดย EVSELECT มีรีวิวผู้ใช้ต่างรถและต่างปีประกอบในช่องเหตุผล ไม่ใช่คะแนนเฉลี่ยจากลูกค้าหรือผลทดสอบมาตรฐาน ข้อมูลผลิตภัณฑ์และการรองรับรถอาจเปลี่ยนตามปี รุ่น และตลาด</p><ul className="list-disc space-y-2 pl-5">{Object.entries(brakeSources).map(([key, source]) => <li key={key}><a href={source.url} className="text-slate-600 underline underline-offset-4 hover:text-lime-800">{source.title}</a></li>)}</ul></section>
