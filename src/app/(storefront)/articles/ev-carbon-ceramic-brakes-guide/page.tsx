  ...
  return <article className={`${styles.article} mx-auto max-w-5xl bg-white px-4 py-10 font-sans text-slate-900 sm:px-6 md:py-16 lg:px-8`}>
    ...
    <div className="mt-10 space-y-12 text-base leading-[1.95] sm:text-lg">
      ...
      <Section id="surface" title="4. จานเรียบ เซาะร่อง เจาะรู — ลายจานบอกอะไรและไม่บอกอะไร">
        ...
        <Note>คำแนะนำด้านความคุ้มค่าในตารางเป็นการสังเคราะห์ของ <BrandHomeLink /> ภาพเป็นตัวอย่างรูปแบบจากผู้ผลิต ไม่ยืนยันว่าจานตามภาพติดตั้งกับรถของผู้อ่านได้ ต้องตรวจรหัสชิ้นส่วนก่อนเสมอ</Note>
      </Section>
      ...
      <Section id="complete-kits" title="8. เทียบชุดหน้าแท้มือหนึ่ง: ต้องรู้รหัสและรู้ว่าได้อะไร">
        ...
        <div className="grid items-start gap-4 sm:grid-cols-2">
          <Photo src="/images/articles/endless-alvell6-official.jpg" alt="คาลิเปอร์ ENDLESS ALVELL6 สีน้ำเงินจากผู้ผลิต สำหรับชุด Alphard และ Vellfire ที่ใช้เป็นราคาอ้างอิง" width={600} height={400}>ภาพผลิตภัณฑ์ <Ref to="alvell6">ENDLESS ALVELL6</Ref> · คนละรุ่นกับ M6 ของเจ้าของรถ ต้องอ่านรหัสชุดประกอบ</Photo>
          <Photo src="/images/articles/project-mu-fs6-official.jpg" alt="คาลิเปอร์ Project mu FS6 หกลูกสูบจากภาพผลิตภัณฑ์ทางการญี่ปุ่น" width={529} height={250}>ภาพผลิตภัณฑ์ <Ref to="fs6">Project μ FS6</Ref> · ภาพคาลิเปอร์ ตารางราคาอ้างรหัสชุดหน้า FS6-T127C พร้อมจาน 380 mm</Photo>
        </div>
