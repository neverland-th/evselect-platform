...
export default function DeepalS05ReviewPage() {
  return (
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16 text-slate-900 bg-white">
      ...
      <p data-contextual-reading className="mb-8 text-sm leading-relaxed text-slate-600">คนที่กำลังเปรียบเทียบ S05 กับรถขับหลังรุ่นอื่น ควรดูวิธีใช้งานของตัวเองควบคู่กับตัวเลขแรงม้า อ่านต่อได้ที่ <Link href="/articles/ev-carbon-ceramic-brakes-guide#energy" className="font-semibold text-lime-800 underline underline-offset-4">น้ำหนักและความเร็วเพิ่มภาระให้เบรกอย่างไร</Link> ซึ่งใช้แบบจำลองอธิบายหลักการ ไม่ใช่ผลทดสอบ S05</p>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 relative z-10">
            ...
            <div className="flex-1 space-y-4 text-center lg:text-left">
              ...
              <h3 className="text-lg sm:text-xl font-extrabold text-white">
                กำลังเตรียมข้อมูลอุปกรณ์สำหรับ Changan Deepal S05
              </h3>
              <p className="text-sm text-slate-300 leading-relaxed">
                หมวดที่กำลังศึกษา ได้แก่ พรมปูพื้น อุปกรณ์จัดพื้นที่เก็บของ อุปกรณ์บังแดด และฟิล์มป้องกันหน้าจอ รายการจริง รุ่นรถที่รองรับ และสเปกอาจเปลี่ยนก่อนเปิดตัว
              </p>
              <div className="pt-2 flex flex-wrap gap-3 justify-center lg:justify-start">
                ...
                >
                  <span>แจ้งความสนใจสำหรับ Deepal S05</span>
