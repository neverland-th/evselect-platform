            ...
            <div className="flex flex-col lg:flex-row items-center gap-8 relative z-10">
              ...
              <div className="flex-1 space-y-4 text-center lg:text-left">
                ...
                <h3 className="text-lg sm:text-xl font-extrabold text-white">
                  กำลังเตรียมข้อมูลอุปกรณ์สำหรับ ZEEKR 009 สเปกไทย
                </h3>
                <p className="text-sm text-slate-300 leading-relaxed">
                  หมวดที่กำลังศึกษา ได้แก่ พรมปูพื้น ฟิล์มป้องกันหน้าจอ อุปกรณ์บังแดด และถาดจัดระเบียบ รายการจริง รุ่นรถที่รองรับ และสเปกอาจเปลี่ยนก่อนเปิดตัว
                </p>
                <div className="pt-2 flex flex-wrap gap-3 justify-center lg:justify-start">
                  ...
                  >
                    <span>แจ้งความสนใจสำหรับ ZEEKR 009</span>
