...
const ALL_ARTICLES: ArticleItem[] = [
  {
    ...
    image: '/images/articles/carbon_ceramic_brake_hero.jpg',
    heroImage: '/images/articles/carbon_ceramic_brake_hero.jpg',
    date: '2026-09-02',
  ...
  },
  {
    ...
    performanceText: '460 hp (0-100: 3.1s)',
    highlights: ['460 hp (Performance)', '0-100 ใน 3.1s', '629 กม. WLTP (LR)', 'Supercharger 250kW'],
    featured: false,
      brand: 'EV',
      badge: 'Thailand focus model',
