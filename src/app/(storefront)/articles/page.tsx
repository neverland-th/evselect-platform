...
const ALL_ARTICLES: ArticleItem[] = [
  {
    ...
    image: '/images/articles/amg-carbon-ceramic-brake-gold.jpg',
    imageAlt: 'ภาพถ่ายเบรก AMG Carbon Ceramic คาลิเปอร์สีทองและจานคาร์บอนเซรามิก',
    heroImage: '/images/articles/amg-carbon-ceramic-brake-gold.jpg',
    date: '2026-09-02',
