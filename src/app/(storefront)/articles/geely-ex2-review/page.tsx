...
export const metadata: Metadata = {
  ...
  description: 'เจาะลึกรีวิว Geely EX2 (Geely Xingyuan) สเปกไทย สไตล์ ชูจุดเด่นขับหลัง RWD 116 แรงม้า ช่วงล่างหลังอิสระ Multi-link หนึ่งเดียวในคลาส แบต Aegis Short Blade Frunk หน้า 70L และจอ Flyme Auto 14.6 นิ้ว',
  keywords: [
    'Geely EX2',
    'รีวิว Geely EX2',
    'Geely EX2 สเปกไทย',
  ...
  alternates: {
    canonical: 'https://evselects.com/articles/geely-ex2-review',
  },
  openGraph: {
    ...
    url: 'https://evselects.com/articles/geely-ex2-review',
  ...
  twitter: {
    ...
    description: 'เจาะลึกซิตี้คาร์ไฟฟ้าขับหลัง ช่วงล่างหลังอิสระ Multi-link และระบบ Flyme Auto สไตล์ ',
...
const jsonLd = {
  ...
  'reviewBody': 'เจาะลึกรีวิว Geely EX2 (Geely Xingyuan) สเปกไทย สไตล์ ชูจุดเด่นขับหลัง RWD 116 แรงม้า ช่วงล่างหลังอิสระ Multi-link หนึ่งเดียวในคลาส แบต Aegis Short Blade Frunk หน้า 70L และจอ Flyme Auto 14.6 นิ้ว',
  ...
  'itemReviewed': {
    ...
    'image': 'https://evselects.com/images/reviews/geely-ex2-hero.jpg'
  },
  'reviewRating': {
    '@type': 'Rating',
    'ratingValue': '8.6',
...
export default function GeelyEX2ReviewPage() {
  return (
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16 text-slate-900 bg-white">
      ...
      <p data-contextual-reading className="mb-8 text-sm leading-relaxed text-slate-600">ถ้าสนใจ EX2 และกำลังคิดเรื่องเปลี่ยนช่วงล่าง ให้เริ่มจาก <Link href="/articles/ev-damper-tuning-bump-rebound-guide#ev-fitment" className="font-semibold text-lime-800 underline underline-offset-4">สิ่งที่ต้องยืนยันว่าโช้คตรงรุ่นและเหมาะกับรถ EV</Link> ไม่สรุปว่าอะไหล่จากรถหน้าตาเหมือนกันจะใช้กับรถสเปกไทยได้</p>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 relative z-10">
            ...
            <div className="flex-1 space-y-4 text-center lg:text-left">
              ...
              <h3 className="text-lg sm:text-xl font-extrabold text-white">
                กำลังเตรียมข้อมูลอุปกรณ์สำหรับ Geely EX2
              </h3>
              ...
              <div className="pt-2 flex flex-wrap gap-3 justify-center lg:justify-start">
                ...
                >
                  <span>แจ้งความสนใจสำหรับ Geely EX2</span>
